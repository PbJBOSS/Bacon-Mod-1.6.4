...
{
	private Icon[] baconMaker = new Icon[6];
	private Icon bacon;
	private Icon baconCookedBlock;
	private Icon[] baconLog = new Icon[2];
	private Icon[] baconLeaves = new Icon[3];
    private Icon plank;
    private Icon[] chest = new Icon[6];
    private Icon[] sand = new Icon[4];
	int[] log;
	...
	private void registerTools()
	{
		...
		MinecraftForge.setBlockHarvestLevel(this, 5, "axe", 0);
		MinecraftForge.setBlockHarvestLevel(this, 6, "axe", 0);
		MinecraftForge.setBlockHarvestLevel(this, 7, "axe", 0);
	}
	...
	@Override
	@SideOnly(Side.CLIENT)
	public int idPicked(World par0, int par1, int par2, int par3) 
	{
		int meta = par0.getBlockMetadata(par1, par2, par3);
		if(meta == 5)
		{
			return BaconItems.baconSapling.blockID;
		}
		else
		{
			return super.idPicked(par0, par1, par2, par3);
		}
	}
	...
	public Icon getBlockTexture(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
	{
		...
		{
			BaconCake tile = (BaconCake)par1IBlockAccess.getBlockTileEntity(par2, par3, par4);
			if(par5 == 0)
			{
				return sand[0];
			}
		...
		{
			BaconLog tile = (BaconLog)par1IBlockAccess.getBlockTileEntity(par2, par3, par4);
		...
		{
			BaconLeave tile = (BaconLeave)par1IBlockAccess.getBlockTileEntity(par2, par3, par4);
		...
		{
			BaconChest tile = (BaconChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4);
	...
	public void breakBlock(World par1, int par2, int par3, int par4, int par5, int par6)
	{
		...
		if(meta == 1)
		{
			this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(BaconItems.rawBacon, 9));
		}
		else if(meta == 0)
		{
			this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(BaconItems.baconMachine, 1, 0));
			dropInventory(par1, par2, par3, par4);
		}
		else if(meta == 2)
		{
			this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(BaconItems.cookedBacon, 9));
		}
		else if(meta == 5)
		{
			BaconLeave bl = (BaconLeave) par1.getBlockTileEntity(par2, par3, par4);
			
			if(bl.getGroth() >= 6500 && bl.getGroth() <= 9000)
			{
				this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(BaconItems.rawBacon, 1 + rand.nextInt(3)));
			}
			
			if(bl.getGroth() > 9000)
			{
				this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(BaconItems.rottedBacon, 1+ rand.nextInt(2)));
			}
			
			if(par1.rand.nextInt(1000) == 0 || bl.getGroth() == 10001)
			{
				this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(BaconItems.baconSapling, 1));
			}
		...
		{
			this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(this, 1, 4));
		}
		else if(meta == 6)
		{
			this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(this, 1, 6));
			dropInventory(par1, par2, par3, par4);
		}
		else if(meta == 7)
		{
			this.dropBlockAsItem_do(par1, par2, par3, par4, new ItemStack(this, 1, 7));
		}
	...
	public boolean onBlockActivated(World par1, int par2, int par3, int par4, EntityPlayer par5, int par6, float par7, float par8, float par9)
	{
		...
		{
			BaconChest tile = (BaconChest) par1.getBlockTileEntity(par2, par3, par4);
			if(tile != null)
			{
	...
	public void updateTick(World world, int i, int j, int k, Random random)
    {
		...
		{
			declayLeaves(world, i, j, k);
		}
		
    }
	
	
	public void declayLeaves(World par0, int par2, int par3, int par4)
	{
        if (!par0.isRemote)
        {
                ...
                if (par0.checkChunksExist(par2 - i1, par3 - i1, par4 - i1, par2 + i1, par3 + i1, par4 + i1))
                {
                    ...
                    for (l1 = -b0; l1 <= b0; ++l1)
                    {
                        for (i2 = -b0; i2 <= b0; ++i2)
                        {
                            for (j2 = -b0; j2 <= b0; ++j2)
                            {
                                k2 = par0.getBlockId(par2 + l1, par3 + i2, par4 + j2);
    ...
    private void removeLeaves(World par1World, int par2, int par3, int par4)
    {
        ...
        BaconLeave tile = (BaconLeave)par1World.getBlockTileEntity(par2, par3, par4);
		if(tile.getGroth() >= 6500 && tile.getGroth() <= 9000)
		{
			this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(BaconItems.rawBacon, 1 + rand.nextInt(3)));
		}
		
		if(tile.getGroth() > 9000)
		{
			this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(BaconItems.rottedBacon, 1+ rand.nextInt(2)));
		}
        
        if(rand.nextInt(1000) == 0 ||tile.getGroth() > 10000)
        {
        	this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(BaconItems.baconSapling));
        }
        par1World.markTileEntityForDespawn(tile);
    }
    	...
    	if(meta == 3)
    	{
    		if(tile != null && tile instanceof BaconCake)
    		{
    			...
    			if(bc.getEatingState() + 1 >= 6)
    			{
    				...
    				par1.markTileEntityForDespawn(bc);
    			}
    			else
    			{
    				bc.setEatedMore();
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
    {
        ...
        if(lb == 3)
        {
        	if(tile != null && tile instanceof BaconCake)
        	{
                ...
                {
                    return AxisAlignedBB.getAABBPool().getAABB((double)((float)par2 + f), (double)par3, (double)((float)par4 + f1), (double)((float)(par2 + 1) - f), (double)((float)par3 + f2 - f), (double)((float)(par4 + 1) - f));
                }
                else if(bc.getFacing() == 5)
                {
                    return AxisAlignedBB.getAABBPool().getAABB((double)((float)par2 + f), (double)par3, (double)((float)par4 + f), (double)((float)(par2 + 1) - f1), (double)((float)par3 + f2 - f), (double)((float)(par4 + 1) - f));
                }
                else if(bc.getFacing() == 3)
                {
                    return AxisAlignedBB.getAABBPool().getAABB((double)((float)par2 + f), (double)par3, (double)((float)par4 + f), (double)((float)(par2 + 1) - f), (double)((float)par3 + f2 - f), (double)((float)(par4 + 1) - f1));
                }
                else
                {
                    return AxisAlignedBB.getAABBPool().getAABB((double)((float)par2 + f1), (double)par3, (double)((float)par4 + f), (double)((float)(par2 + 1) - f), (double)((float)par3 + f2 - f), (double)((float)(par4 + 1) - f));
	...
	public ArrayList<ItemStack> onSheared(ItemStack item, World world, int x, int y, int z, int fortune) 
	{
		...
		if(meta == 5)
		{
			BaconLeave bl = (BaconLeave) world.getBlockTileEntity(x, y, z);
			...
			world.markTileEntityForDespawn(bl);
		}
		return dropList;
	}
