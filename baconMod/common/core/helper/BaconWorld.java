...
public class BaconWorld 
{
	...
	{
		TileEntity tile;
		if(side == 0)return tile = par0.getBlockTileEntity(par1, par2-1, par3);
		if(side == 1)return tile = par0.getBlockTileEntity(par1, par2+1, par3);
		if(side == 2)return tile = par0.getBlockTileEntity(par1, par2, par3-1);
		if(side == 3)return tile = par0.getBlockTileEntity(par1, par2, par3+1);
		if(side == 4)return tile = par0.getBlockTileEntity(par1-1, par2, par3);
		if(side == 5)return tile = par0.getBlockTileEntity(par1+1, par2, par3);
		return null;
	}
	...
	public static boolean isSameBlock(World par0, int par1, int par2, int par3, int side, int BlockID)
	{
		...
		if(side == 0)
		{
			if(par0.getBlockId(par1, par2-1, par3) == BlockID)
			{
				return true;
			}
		}
		...
		{
			if(par0.getBlockId(par1, par2, par3-1) == BlockID)
			{
				return true;
			}
		}
		...
		{
			if(par0.getBlockId(par1-1, par2, par3) == BlockID)
			{
				return true;
			}
		}
	...
	public static boolean isBlockAir(World par0, int par1, int par2, int par3, int side)
	{
		...
		if(side == 0)
		{
			if(par0.getBlockId(par1, par2-1, par3) == 0)
			{
				return true;
			}
		}
		...
		{
			if(par0.getBlockId(par1, par2, par3-1) == 0)
			{
				return true;
			}
		}
		...
		{
			if(par0.getBlockId(par1-1, par2, par3) == 0)
			{
				return true;
			}
		}
	...
	public static void setThisBlockWithMeta(World par0, int par1, int par2, int par3, int side, int blockID, int meta)
	{
		if(side == 0)
		{
	...
	{
		if(side == 0)return par0.getBlockId(par1, par2-1, par3);
		else if(side == 1)return par0.getBlockId(par1, par2+1, par3);
		else if(side == 2)return par0.getBlockId(par1, par2, par3-1);
		else if(side == 3)return par0.getBlockId(par1, par2, par3+1);
		else if(side == 4)return par0.getBlockId(par1-1, par2, par3);
		else return par0.getBlockId(par1+1, par2, par3);
	}
	...
	public static void setSidedBlockAndMetadata(World par0, int par1, int par2, int par3, int side, int blockID, int meta)
	{
