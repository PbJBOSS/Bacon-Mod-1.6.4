...
import minecraftwero.baconMod.common.core.handlers.BaconCraftingHandler;
...
import minecraftwero.baconMod.common.recipes.BaconRecipes;
...
//        BaconRecipes.loadRecipes();
        ...
        LanguageRegistry.instance().addStringLocalization("itemGroup."+BaconLib.modID, "Bacon Mod");
        ...
        GameRegistry.registerCraftingHandler(new BaconCraftingHandler());
    }
