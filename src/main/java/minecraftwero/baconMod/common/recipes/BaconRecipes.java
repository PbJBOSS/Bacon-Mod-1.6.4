...
public class BaconRecipes 
{
	...
	public static void loadRecipes() 
	{
		...
		{
			GameRegistry.addRecipe(new ItemStack(BaconItems.sawMill, 1), new Object[] {"III", "IWI", "III", 'W', Items.iron_ingot, 'I', Blocks.iron_bars});
		}
		...
		{
			GameRegistry.addSmelting(BaconItems.rawBacon, new ItemStack(BaconItems.cookedBacon), 0.1F);
		}
		...
		{
			GameRegistry.addSmelting(Items.milk_bucket, new ItemStack(BaconItems.cheeseWheel), 0.1F);
		}
